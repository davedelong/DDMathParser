...
public class Expression {
    ...
    public init(string: String, operatorSet: OperatorSet = OperatorSet.default, options: TokenResolverOptions = TokenResolverOptions.defaultOptions, locale: Locale? = nil) throws {
