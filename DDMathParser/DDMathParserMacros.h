...
#ifndef DD_ERR
#define DD_ERR(_c,_f,...) [NSError errorWithDomain:DDMathParserErrorDomain code:(_c) userInfo:@{ DDMathParserFailureReasonKey: [NSString stringWithFormat:(_f), ##__VA_ARGS__]}]
#endif
